...
public:
    ...
    constexpr btree_iterator &operator=(const btree_iterator &o) = default;
    //constexpr btree_iterator &operator=(const btree_iterator &o) {node = o.node;position = o.position; return *this;}
